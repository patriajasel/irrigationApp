...
class _applyScheduleState extends State<applySchedule> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 10), () {
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MyDashboard()));
    });
